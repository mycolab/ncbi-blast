...
/*  $Id: ncbi_atomic_defs.h 624283 2021-01-27 19:19:35Z ivanov $
* ===========================================================================
*
...
#if !defined(NCBI_SWAP_POINTERS) \
    &&  !defined(NCBI_SWAP_POINTERS_CONDITIONALLY) \
    &&  !defined(NCBI_NO_THREADS) \
    &&  (!defined(NCBI_COUNTER_ASM_OK) \
